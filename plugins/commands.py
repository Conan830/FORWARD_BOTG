...
buttons=InlineKeyboardMarkup(
        [
            ...
            [
                InlineKeyboardButton("Source Code", url="https://github.com/Kishan484/FORWARD_BOTG"),
                InlineKeyboardButton("Updates Channel", url="https://t.me/Kishan484")
            ]
        ]
        )
...
async def cb_abt(bot, cb):
    ...
    reply_markup=InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("Source", url="https://github.com/Kishan484/FORWARD_BOTG"),
            ]
        ]
    )
    )
